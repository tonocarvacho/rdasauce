...
<?php $bande = get_field( "banderas");  
$img_atts = wp_get_attachment_image_src( $bande, $default );
$img_src = $img_atts[0];
?>
						<h3 class="montserrat delgado"><?php echo get_field( "texto_principal_a"); ?> <strong><?php echo get_field( "texto_principal_negrita"); ?></strong> <?php echo get_field( "texto_principal_b"); ?> </h3>
						<img class="banderaslide" src="<?php echo $img_src ?>" alt="" />
						
					</div>
					<div class="fondoform ">
                          <h3 class="titform"><i class="fa fa-check naranja"></i><?php echo get_field( "texto_formulario_a"); ?> </h3>
                          <p class="subtform"><?php echo get_field( "texto_formulario_b"); ?></p>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<h3>Si quieres vender en Chile...<br>
<strong>ASESÓRATE CON NOSOTROS</strong><br>
Desde emprendedores<br>
hasta grandes empresas </h3>
